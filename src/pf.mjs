...
var pathfinder = (function () {
  var _scriptDir = '/pf.wasm';

  return (
    function (pathfinder) {
      pathfinder = pathfinder || {};

      var Module = typeof pathfinder !== "undefined" ? pathfinder : {};
      ...
      var _DP_tsp = Module["_DP_tsp"] = function () {
        return (_DP_tsp = Module["_DP_tsp"] = Module["asm"]["o"]).apply(null, arguments);
      };
      ...
      var _calloc = Module["_calloc"] = function () {
        return (_calloc = Module["_calloc"] = Module["asm"]["t"]).apply(null, arguments);
      };
